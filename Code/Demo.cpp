...
void Demo::build_swapchain_cmds()
{
	...
	for (uint32_t i = 0; i < swapchainImageCount; i++)
	{
		...
		// For this simple tutorial of setting the window color,
		// we do not give any commands inside the renderpass.
		// All we do is begin the renderpass, and end the renderpass,
